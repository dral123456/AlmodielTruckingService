$(document).ready(() => {
        ...
        $(document).on("click", ".clickable-row", function() {
                ...
                window.location.href = `../adminPages/assignDriver.html?id=${id}`;
            });
